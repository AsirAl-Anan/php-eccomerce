    ...
    <div class="mt-8 bg-white p-6 rounded-lg shadow-md">
        ...
        <form id="ratingForm" action="" method="POST" class="hidden">
            <div class="mb-4">
                ...
                <select name="rating" id="rating" class="shadow border rounded w-full py-2 px-3 text-gray-200 leading-tight focus:outline-none focus:shadow-outline" required>
                    <option class=" bg-white text-black" value="">Select a rating</option>
                    <optio class=" bg-white text-black"n value="5" <?php echo $userRating && $userRating['rating'] == 5 ? 'selected' : ''; ?>>5 Stars</option>
