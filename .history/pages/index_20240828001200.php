...
// Fetch offer images and timer from the database
$sql = "SELECT * FROM offers ORDER BY id DESC LIMIT 5";
...
<div class=""  id="featured">
  ...
  <?php displayProducts($products); ?> 
    ...
    <!-- category section -->
    <section class="py-10">
    <div class="offer-section bg-gray-100 p-4 rounded-lg shadow-md">
    <div class="carousel w-full max-w-3xl mx-auto">
        <?php foreach ($offers as $offer): ?>
            <div class="carousel-item">
                <img src="<?php echo $offer['image_path']; ?>" alt="<?php echo $offer['title']; ?>" class="w-full h-64 object-cover rounded-lg">
            </div>
        <?php endforeach; ?>
    </div>
    <div class="timer text-center mt-4 text-2xl font-bold text-blue-600" data-end="<?php echo $timer['end_time']; ?>">
