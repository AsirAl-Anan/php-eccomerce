...
<div class=""  id="featured">
  ...
  <?php displayProducts($products); ?> 
    ...
    <div class="flex w-full h-[43vh]">
    <div class="w-[83%] h-full relative overflow-hidden">
    ...
    <div class="w-[18%] bg-gray-200 flex flex-col items-center justify-center">
...
function updateSlidePosition() {
    ...
    console.log('Current slide:', currentSlide, 'Offset:', offset); // Debugging
}

function moveSlide(direction) {
    currentSlide = (currentSlide + direction + totalSlides) % totalSlides; // Loop back to the first slide
    updateSlidePosition();
    console.log('Moved slide:', direction); // Debugging
}
