...
<html lang="en">
  ...
  <div class="flex items-center justify-between mb-6">
    <div class="flex items-center">
      <img class="h-20 w-20 rounded-full object-cover" src="profile.jpg" alt="Profile Picture">
      <div class="ml-4">
        <h2 class="text-2xl font-semibold text-gray-800">John Doe</h2>
        <p class="text-gray-600">johndoe@example.com</p>
      </div>
    </div>
    <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">Edit Profile</button>
  </div>

  <!-- Tabs (optional) -->
  <div class="border-b mb-6">
    <ul class="flex space-x-4">
      <li class="text-blue-500 border-b-2 border-blue-500 pb-2">Profile</li>
      <li class="text-gray-600 hover:text-gray-800 cursor-pointer">Orders</li>
      <li class="text-gray-600 hover:text-gray-800 cursor-pointer">Wishlist</li>
      <li class="text-gray-600 hover:text-gray-800 cursor-pointer">Settings</li>
    </ul>
  </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
    ...
    <div class="bg-gray-100 p-4 rounded-lg">
      ...
      <p class="text-gray-600 mt-2"><strong>Address:</strong> 123 Main St, City, Country</p>
    </div>

    <!-- Account Settings -->
    <div class="bg-gray-100 p-4 rounded-lg">
      <h3 class="text-lg font-medium text-gray-700 mb-4">Account Settings</h3>
      <button class="bg-gray-200 text-gray-800 px-4 py-2 rounded w-full text-left">Change Password</button>
      <button class="bg-gray-200 text-gray-800 px-4 py-2 rounded w-full text-left mt-4">Notification Settings</button>
    </div>
  </div>
  ...
  <div class="bg-gray-100 p-4 rounded-lg">
    ...
    <ul class="divide-y divide-gray-300">
      <li class="py-2 flex justify-between">
        ...
        <span class="text-gray-600">June 20, 2024</span>
      </li>
      <li class="py-2 flex justify-between">
        <span>Order #12346</span>
        <span class="text-gray-600">June 22, 2024</span>
      </li>
      <!-- More orders... -->
    </ul>
  </div>
  ...
  <div class="mt-6 flex justify-between items-center">
    ...
    <a href="#" class="text-blue-500 hover:underline">Need help?</a>
  </div>
</div>
