  ...
  <body class="bg-gray-100 text-gray-800">
    ...
    <div class="container mx-auto px-4 py-12">
      <div class="bg-white shadow-md rounded-lg p-8">
        <h1 class="text-4xl font-bold mb-8 text-gray-900">User Profile</h1>
        <form
          action="profile.php"
          method="POST"
        ...
        >
          <div>
            ...
            <input
              ...
              required
              class="mt-2 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 text-lg"
            />
          </div>
          <div>
          ...
          <div>
            ...
            <input
              ...
              accept="image/*"
              class="mt-2 block w-full text-lg text-gray-700"
            />
            ...
            <div class="mt-4">
              <img
                ...
                alt="Profile Picture"
                class="max-w-[200px] rounded-md shadow-md"
              />
            </div>
            <?php endif; ?>
          </div>
          <div>
            <button
              type="submit"
              class="inline-flex justify-center py-3 px-6 border border-transparent shadow-sm text-lg font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition ease-in-out duration-150"
            >
              Update Profile
            </button>
          </div>
