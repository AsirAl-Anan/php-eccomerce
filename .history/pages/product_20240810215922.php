        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
            ...
            <?php if (isLoggedIn()): ?>
                <form action="" method="POST" enctype="multipart/form-data" class="mb-8">
                    <textarea name="comment"  rows="4" class="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent mb-4 text" placeholder="Write your comment here..."></textarea>
