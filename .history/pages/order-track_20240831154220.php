...
if (isset($_POST['cancel_order'])) {
    ...
    if ($order) {
        ...
        $current_time = time();
        $time_diff = ($current_time - $order_time) / 60; // difference in minutes
        ...
        <?php if (isset($order_details) && !empty($order_details)): ?>
            <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <form method="post" class="mt-4">
                    ...
                    <button type="submit" name="cancel_order" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" <?php echo !isOrderCancellable($order_details[0]['created_at']) ? 'disabled' : ''; ?>>
                        Cancel Order
                    </button>
                </form>
            </div>
                ...
                <?php foreach ($orders as $order): ?>
                    <div class="bg-white shadow-md rounded px-4 py-2 flex justify-between items-center">
                        ...
                        <form method="post" class="ml-4">
                            ...
                            <button type="submit" name="cancel_order" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded text-sm" <?php echo !isOrderCancellable($order['created_at']) ? 'disabled' : ''; ?>>
                                Cancel
                            </button>
                        </form>
                    </div>
