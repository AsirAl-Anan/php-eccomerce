    ...
    <div class="mt-8 bg-white p-6 rounded-lg shadow-md">
        ...
        <form id="ratingForm" action="" method="POST" class="hidden">
            <div class="mb-4">
                ...
                <select name="rating" id="rating" class="shadow border rounded w-full py-2 px-3 text-gray-200 leading-tight focus:outline-none focus:shadow-outline w-10" required>
                    <option class=" bg-white text-black" value="">Select a rating</option>
                    <option class=" bg-white text-black" value="5" <?php echo $userRating && $userRating['rating'] == 5 ? 'selected' : ''; ?>>5 Stars</option>
                    <option class=" bg-white text-black" value="4" <?php echo $userRating && $userRating['rating'] == 4 ? 'selected' : ''; ?>>4 Stars</option>
                    <option class=" bg-white text-black" value="3" <?php echo $userRating && $userRating['rating'] == 3 ? 'selected' : ''; ?>>3 Stars</option>
                    <option class=" bg-white text-black" value="2" <?php echo $userRating && $userRating['rating'] == 2 ? 'selected' : ''; ?>>2 Stars</option>
                    <option class=" bg-white text-black" value="1" <?php echo $userRating && $userRating['rating'] == 1 ? 'selected' : ''; ?>>1 Star</option>
                </select>
            </div>
