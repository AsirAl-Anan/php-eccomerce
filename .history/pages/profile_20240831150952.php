    ...
    <div class="container mx-auto px-4 py-12 flex">
      ...
      <div class="w-1/4 bg-white rounded-lg shadow-md p-6">
        <div class="text-center mb-8">
          <img
            src="<?php echo htmlspecialchars($user['profile_picture'] ? $user['profile_picture'] : '../uploads/default_avatar.jpg'); ?>"
            alt="Profile Picture"
        ...
        >
          <div class="grid grid-cols-2 gap-6">
            <div>
              <label
                for="username"
                class="block text-lg font-medium text-gray-700 hover:border-indigo-500" 
                >Username:</label
              >
              <input
                type="text"
                ...
                required
                class="mt-2 p-1 block w-full rounded-lg border-gray-300 bg-gray-500 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 text-lg text-white"
              />
            </div>
            <div>
