          ...
          <div class="grid grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                required
                class="mt-2 p block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 text-lg text-white"
              />
            </div>
            <div>
