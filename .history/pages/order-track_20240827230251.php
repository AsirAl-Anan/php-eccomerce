...
<div class="navbar text-black sticky top-0 z-50 !bg-white !text-black">
  <div class="navbar-start">
    ...
    <div class="dropdown">
      ...
      >
        ...
        <li><a href="order-track.php" class="hover:underline" href="order-track.php">Order Tracking</a></li>
  ...
  <div class="navbar-center hidden lg:flex">
    <ul class="menu menu-horizontal px-1 z-20">
      ...
      <li><a href="index#featured" class="hover:underline">New & featured</a></li>
      <li>
