...
$currentPage = 'about'; // Change this to the current page name
$about_query = "SELECT * FROM about_faq WHERE section IN ('Company Overview', 'Founders and Team Members', 'Story Behind the Brand', 'Customer Commitment', 'Contact Information')";
$about_result = $conn->query($about_query);

// Fetch FAQ content
$faq_query = "SELECT * FROM about_faq WHERE section = 'FAQ'";
...
<div class="container mx-auto p-6 bg-white shadow-md">
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-semibold text-gray-700 mb-4">Company Overview</h2>
            <p class="text-gray-600"><?php echo nl2br($aboutData['company_overview']); ?></p>
        </section>

        <!-- Founders and Team Members Section -->
        <section class="mb-8">
            <h2 class="text-2xl font-semibold text-gray-700 mb-4">Founders and Team Members</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <?php while($member = mysqli_fetch_assoc($teamResult)) { ?>
                    <div class="text-center">
                        <img src="../uploads/group-members/<?php echo $member['image']; ?>" alt="<?php echo $member['name']; ?>" class="rounded-full w-32 h-32 mx-auto mb-4">
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-semibold text-gray-700 mb-4">Story Behind the Brand</h2>
            <p class="text-gray-600"><?php echo nl2br($aboutData['brand_story']); ?></p>
        </section>

        <!-- Customer Commitment Section -->
        <section class="mb-8">
            <h2 class="text-2xl font-semibold text-gray-700 mb-4">Customer Commitment</h2>
            <p class="text-gray-600"><?php echo nl2br($aboutData['customer_commitment']); ?></p>
        </section>

        <!-- Contact Information Section -->
        <section class="mb-8">
            <h2 class="text-2xl font-semibold text-gray-700 mb-4">Contact Information</h2>
            <p class="text-gray-600"><?php echo nl2br($aboutData['contact_information']); ?></p>
        </section>
    </div>
