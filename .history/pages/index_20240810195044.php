...
<div class="navbar text-black sticky top-0 z-50 !bg-white !text-black">
  <div class="navbar-start">
    ...
    <div class="dropdown">
      ...
      >
        ...
        <li><a class="hover:underline" href="blog.php">Order Tracking</a></li>
  ...
  <div class="navbar-center hidden lg:flex">
    <ul class="menu menu-horizontal px-1 z-20">
      ...
      <li>
        <details>
          <summary class="hover:underline" ><a href="men.php">Men</a></summary>
      ...
      <li>
        <details>
          <summary class="hover:underline"><a href="women.php">Women</a></summary>
          <ul class="p-2 bg-white text-black border border-gray-200 shadow-lg rounded-md">
            <li><a class="hover:underline">Submenu 1</a></li>
            <li><a class="hover:underline">Submenu 2</a></li>
          </ul>
      ...
      <li><a href="pages/about.php" class="hover:underline"  href="pages/about.php">About & FAQ's</a></li>
    </ul>
  </div>
...
<!-- carousel ends -->
  <p class="text-2xl font-bold text-center m-5" id="featured">Featured</p>
   <?php 
   require_once '../config/config.php';
   require_once '../admin/display_products.php';
