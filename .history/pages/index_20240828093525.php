...
<div class=""  id="featured">
  ...
  <?php displayProducts($products); ?> 
    ...
    <div class="w-[85%] h-full relative overflow-hidden">
        ...
        <button class="absolute left-4 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 hover:bg-opacity-75 text-white font-bold py-2 px-4 rounded-full transition duration-300">❮</button>
<button class="absolute right-4 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 hover:bg-opacity-75 text-white font-bold py-2 px-4 rounded-full transition duration-300">❯</button>
    </div>
...
document.querySelector('button[onclick="moveSlide(-1)"]').addEventListener('click', () => moveSlide(-1));
document.querySelector('button[onclick="moveSlide(1)"]').addEventListener('click', () => moveSlide(1));
...
// Initialize the carousel and timer
