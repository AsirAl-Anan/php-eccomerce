...
<div class="container mx-auto p-6">
    ...
    <div id="about">
        <?php while ($row = $about_result->fetch_assoc()) : ?>
            <?php if ($row['section'] == 'Founders and Team Members') : ?>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="text-center">
                        <img src="<?= $row['image']; ?>" alt="<?= $row['name']; ?>" class="mx-auto rounded-full">
                        <h3 class="mt-4 text-xl font-semibold"><?= $row['name']; ?></h3>
                        <p class="text-gray-600"><?= $row['position']; ?></p>
                    </div>
                </div>
            <?php else : ?>
                <div class="mb-8">
                    <h2 class="text-2xl font-semibold"><?= $row['section']; ?></h2>
                    <p class="mt-4 text-gray-600"><?= nl2br($row['content']); ?></p>
                </div>
            <?php endif; ?>
        <?php endwhile; ?>
    </div>
            ...
            <?php while ($row = $faq_result->fetch_assoc()) : ?>
                <div class="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box mb-2">
                    ...
                    <div class="collapse-content">
                        <p><?= nl2br($row['accordion_content']); ?></p>
                    </div>
                </div>
            <?php endwhile; ?>
        </div>
