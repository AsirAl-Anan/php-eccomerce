...
<div class="container mx-auto py-12">
        ...
        <?php foreach ($aboutContent as $section): ?>
            <div class="mb-12">
                <h2 class="text-2xl font-semibold mb-4"><?= htmlspecialchars($section['section_name']) ?></h2>
                <p class="mb-4"><?= nl2br(htmlspecialchars($section['section_content'])) ?></p>
                <?php if (!empty($section['image_path'])): ?>
                    <img src="<?= htmlspecialchars($section['image_path']) ?>" alt="<?= htmlspecialchars($section['section_name']) ?>" class="w-full h-auto mb-4">
                <?php endif; ?>
            </div>
        <?php endforeach; ?>
    </div>
