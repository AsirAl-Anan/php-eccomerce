...
$products = getProductsForPage($conn, $currentPage, $sort, $min_price, $max_price, $date_filter);
?>
...
?>
    ...
    <!-- navigation bar ends -->
     <!-- Add the filter form -->
     <?php displayFilterForm($currentPage, $sort, $min_price, $max_price, $date_filter); ?>
