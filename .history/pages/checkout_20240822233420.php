        ...
        <div class="flex justify-between items-center mb-4">
            <div class="flex items-center">
                ...
                <?php elseif (!empty($item['image_url'])): ?>
                    <img src="<?php echo htmlspecialchars($item['image_url']); ?>" alt="<?php echo htmlspecialchars($item['name']); ?>" class="w-16 h-16 object-cover mr-4">
                <?php else: ?>
                ...
                <div>
                    ...
                    <br>
                    <a href="product.php?id=<?php echo $item['product_id']; ?>" class="text-blue-500 hover:underline">View Product</a>
                </div>
            </div>
