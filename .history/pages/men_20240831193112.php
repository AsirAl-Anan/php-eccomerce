...
?>
   ...
   <form method="GET" action="" class="mb-4">
    <select class="bg-white border-black"  name="sort" onchange="this.form.submit()" class="p-2 border rounded">
        <option value="">Sort by...</option>
        <option class="bg-white" value="price_asc" <?php echo ($_GET['sort'] ?? '') == 'price_asc' ? 'selected' : ''; ?>>Price: Low to High</option>
        <option  class="bg-white"  value="price_desc" <?php echo ($_GET['sort'] ?? '') == 'price_desc' ? 'selected' : ''; ?>>Price: High to Low</option>
        <option class="bg-white"  value="name_asc" <?php echo ($_GET['sort'] ?? '') == 'name_asc' ? 'selected' : ''; ?>>Name: A to Z</option>
        <option  class="bg-white" value="name_desc" <?php echo ($_GET['sort'] ?? '') == 'name_desc' ? 'selected' : ''; ?>>Name: Z to A</option>
        <option  class="bg-white" value="rating_desc" <?php echo ($_GET['sort'] ?? '') == 'rating_desc' ? 'selected' : ''; ?>>Highest Rated</option>
    </select>
</form>
