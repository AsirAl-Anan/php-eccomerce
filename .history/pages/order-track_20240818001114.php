    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <?php if (isset($order_details)): ?>
            <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <h2 class="text-2xl font-bold mb-4">Order #<?php echo $order_details[0]['id']; ?></h2>
                <p>Status: <?php echo $order_details[0]['status']; ?></p>
                <p>Date: <?php echo $order_details[0]['created_at']; ?></p>
                <p>Total: $<?php echo number_format($order_details[0]['total_amount'], 2); ?></p>
        ...
        <?php else: ?>
            <div class="grid gap-4">
                <?php foreach ($orders as $order): ?>
                    <a href="?order_id=<?php echo $order['id']; ?>" class="bg-white shadow-md rounded px-4 py-2 flex justify-between items-center hover:bg-gray-50">
