            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    <button onclick="addToCart(<?php echo $product['id']; ?>, '<?php echo htmlspecialchars(addslashes($product['name'])); ?>', <?php echo $product['price']; ?>); console.log('Add to Cart clicked');" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        ...
                        <button onclick="addToCart(<?php echo $product['id']; ?>, '<?php echo htmlspecialchars(addslashes($product['name'])); ?>', <?php echo $product['price']; ?>);" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2">
    Add to Cart
</button>
<a href="checkout.php?product_id=<?php echo $product['id']; ?>" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
    Buy Now
</a>
                </div>
            </div>
        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
            ...
            <?php if (isLoggedIn()): ?>
                <form action="" method="POST" enctype="multipart/form-data" class="mb-8">
                    <textarea name="comment"  rows="4" class="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent mb-4 text-white" placeholder="Write your comment here..."></textarea>
            ...
            <?php else: ?>
                <p class="text-gray-500">Please <a href="../loginsystem/login.php" class="text-blue-600 font-medium hover:underline">log in</a> to leave a comment.</p>
            <?php endif; ?>
    ...
    <div class="bg-gray-50 p-6 rounded-lg shadow-sm mb-6 transition-transform transform hover:scale-105" id="comment-<?php echo $comment['id']; ?>">
        <div class="flex items-center mb-4">
            ...
            ?>
            <img src="<?php echo $profilePicture; ?>" alt="Profile Picture" class="w-10 h-10 rounded-full mr-4 object-cover">
