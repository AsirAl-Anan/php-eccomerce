...
<div class="navbar text-black sticky top-0 z-50 !bg-white !text-black">
  <div class="navbar-start">
    ...
    <div class="dropdown">
      ...
      >
        ...
        <li>
          <a href="../pages/men.php" class="hover:underline">Men</a>
          <ul class="p-2">
        ...
        <li><a class="hover:underline"  href="order-track.php">Order-track</a></li>
  ...
  <div class="navbar-center hidden lg:flex">
    <ul class="menu menu-horizontal px-1 z-20">
      ...
      <li>
        <details>
          <summary class="hover:underline"  href="women.php">Women</summary>
