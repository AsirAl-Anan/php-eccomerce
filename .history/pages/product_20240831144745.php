        ...
        <form id="ratingForm" action="" method="POST" class="hidden">
            <div class="mb-4">
                ...
                <select name="rating" id="rating" class="shadow border rounded w-full py-2 px-3 text-gray-200 leading-tight focus:outline-none focus:shadow-outline" required>
                    ...
                    <option class=" bg-white" value="2" <?php echo $userRating && $userRating['rating'] == 2 ? 'selected' : ''; ?>>2 Stars</option>
                    <option class=" bg-white" value="1" <?php echo $userRating && $userRating['rating'] == 1 ? 'selected' : ''; ?>>1 Star</option>
                </select>
            </div>
