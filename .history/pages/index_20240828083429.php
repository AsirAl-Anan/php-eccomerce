...
<div class=""  id="featured">
  ...
  <?php displayProducts($products); ?> 
    ...
    <div class="carousel w-[85%] h-full relative">
        <?php foreach ($offer_slides as $index => $slide): ?>
            <div id="slide<?php echo $index + 1; ?>" class="carousel-item relative w-full h-full">
                ...
                <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    <a href="#slide<?php echo ($index === 0) ? count($offer_slides) : $index; ?>" class="btn btn-circle">❮</a> 
                    <a href="#slide<?php echo ($index === count($offer_slides) - 1) ? 1 : $index + 2; ?>" class="btn btn-circle">❯</a>
                </div>
            </div>
        <?php endforeach; ?>
    </div>
