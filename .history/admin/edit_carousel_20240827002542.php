...
if (isset($_POST['update_slide'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>
        alert('Added to Carousel Successfully')
        </script>";
    } else {
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="edit_about_page.php" class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-700"><Button class="btn btn-info">Add Admin</Button></a>
