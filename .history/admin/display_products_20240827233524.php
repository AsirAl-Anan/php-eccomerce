        ...
        <?php foreach ($products as $product): ?>
            <div class="border rounded-lg overflow-hidden shadow-lg flex flex-col h-full">
                ...
                <div class="p-4 flex flex-col flex-grow">
                    ...
                    <button onclick="<?php echo   "addToCart({$product['id']}, '" . htmlspecialchars(addslashes($product['name'])) . "', {$product['price']})" : "showLoginAlert()"; ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex-grow">
                        Add to Cart
                    </button>
