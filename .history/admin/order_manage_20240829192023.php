...
// Modify the SQL query to include the user's profile picture as well fetch data

$stmt = $conn->prepare("SELECT o.*, u.username, u.profile_picture FROM orders o JOIN users u ON o.user_id = u.id ORDER BY o.created_at DESC");
$stmt->execute();
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-left">
                                <div class="flex items-center">
                                    <div class="mr-2">
                                        <?php
                                        $profile_picture = $order['profile_picture'] ? '../uploads/' . $order['profile_picture'] : '../uploads/default_avatar.jpg';
                                        ?>
                                        <img class="w-6 h-6 rounded-full" src="<?php echo htmlspecialchars($profile_picture); ?>" alt="User profile">
                                    </div>
                            ...
                            <td class="py-3 px-6 text-left">
                                <span class="bg-<?php echo getStatusColor($order['status']); ?>-200 text-<?php echo getStatusColor($order['status']); ?>-600 py-1 px-3 rounded-full text-xs">
                            ...
                            <td class="py-3 px-6 text-left">
                                <form method="POST" class="flex items-center">
                                    ...
                                    <button type="submit" class="bg-blue-500 text-white px-2 py-1 rounded ml-2 text-xs">Update</button>
                                </form>
                            </td>
                        </tr>
                    <?php endforeach; ?>
