        ...
        <?php foreach ($products as $product): ?>
            <div class="border rounded-lg overflow-hidden shadow-lg flex flex-col h-full">
                ...
                <div class="p-4 flex flex-col flex-grow">
                    <div class="flex-grow">
                        <h3 class="font-bold text-xl mb-2 line-clamp-2"><?php echo htmlspecialchars($product['name']); ?></h3>
                        <p class="text-gray-700 text-base mb-4 line-clamp-3"><?php echo htmlspecialchars($product['description']); ?></p>
                    </div>
                    <div class="mt-auto">
                        ...
                        <div class="flex space-x-2">
                            <button onclick="addToCart(<?php echo $product['id']; ?>, '<?php echo htmlspecialchars(addslashes($product['name'])); ?>', <?php echo $product['price']; ?>); console.log('Add to Cart clicked');" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex-grow">
                                Add to Cart
                            </button>
