...
<nav class="bg-white border-b border-gray-200">
        <div class="container mx-auto flex items-center justify-between py-4 px-6">
            ...
            <div class="flex items-center space-x-4">
                ...
                <!-- Profile Dropdown -->
                <div class="relative">
                    <div role="button" id="dropdownButton" class="btn btn-ghost btn-circle avatar cursor-pointer">
                    ...
                    <ul id="dropdownMenu" class="menu menu-sm dropdown-content bg-gray-400 rounded-box z-[1] mt-3 w-52 p-2 shadow hidden">
                        <?php if (isLoggedIn()): ?>
