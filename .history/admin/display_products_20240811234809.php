            ...
            <?php foreach ($products as $product): ?>
                <div class="border rounded-lg overflow-hidden shadow-lg">
                    ...
                    <div class="p-4">
                        ...
                        <button onclick="buyNow(<?php echo $product['id']; ?>)" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded ml-2">
    Buy Now
</button>
                    </div>
                </div>
    ...
    .then(text => {
        ...
        try {
            ...
            if (data.success) {
                ...
                showAlert(`Failed to add product to cart: ${data.message}`);
            }
        } catch (error) {
