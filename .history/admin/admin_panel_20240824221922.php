...
<nav id="sideNav" class="bg-gray-800 text-white w-64 min-h-screen p-4">
        <h1 class="text-2xl font-bold mb-6">Admin Panel</h1>
        <ul>
            <li class="mb-4"><a href="#userManagement" class="hover:text-gray-300">User Management</a></li>
            <li class="mb-4"><a href="#productManagement" class="hover:text-gray-300">Product Management</a></li>
            <li class="mb-4"><a href="#carouselManagement" class="hover:text-gray-300">Carousel Management</a></li>
            <li class="mb-4"><a href="#orderManagement" class="hover:text-gray-300">Order Management</a></li>
        </ul>
    </nav>
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <form id="editForm" method="POST" action="">
                    ...
                    <button onclick="openEditModal(<?php echo htmlspecialchars(json_encode($user)); ?>)" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded">Edit</button>
    ...
    <select id="edit_product_page" name="page" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
    ...
    <input type="file" id="product_images" name="product_images[]" accept=".jpg,.jpeg,.png" multiple class="w-full p-2 border rounded">
</div>
            </div>
...
<form method="POST" action="" enctype="multipart/form-data" class="mb-8">
    ...
    <button type="submit" name="add_slide" class="mt-4 bg-blue-500 text-white px-4 py-2 rounded">Add Slide</button>
</form>
...
<div id="editSlideModal" class="fixed z-10 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" aria-hidden="true"></div>
        <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <form id="editSlideForm" method="POST" action="" enctype="multipart/form-data">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Edit Carousel Slide</h3>
                    <div class="mt-2">
                        <input type="hidden" id="edit_slide_id" name="slide_id">
                        <div class="mb-4">
                            <label for="edit_image_file" class="block text-gray-700 text-sm font-bold mb-2">Image File:</label>
                            <input type="file" id="edit_image_file" name="image_file" accept="image/*" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            <img id="current_image" src="" alt="Current Image" class="mt-2 max-w-full h-auto" style="display: none;">
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="edit_button_text" class="block text-gray-700 text-sm font-bold mb-2">Button Text:</label>
                            <input type="text" id="edit_button_text" name="button_text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
                        <div class="mb-4">
                            <label for="edit_button_link" class="block text-gray-700 text-sm font-bold mb-2">Button Link:</label>
                            <input type="text" id="edit_button_link" name="button_link" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
                        <div class="mb-4">
                            <label for="edit_slide_order" class="block text-gray-700 text-sm font-bold mb-2">Slide Order:</label>
                            <input type="number" id="edit_slide_order" name="slide_order" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="submit" name="update_slide" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">
                        Save Changes
                    </button>
                    <button type="button" onclick="closeEditSlideModal()" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                        Cancel
                    </button>
                </div>
            </form>
