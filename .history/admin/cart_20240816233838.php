...
<div class="navbar bg-base-100">
  <div class="navbar-start">
    ...
    <div class="dropdown">
      ...
      >
        ...
        <li><a href="../index.php#featured">New & featured</a></li>
        <li>
        ...
        <li><a href="../about.php">About & FAQ's</a></li>
      </ul>
    </div>
    <!-- responsive nav-bar ends -->
    <a class="btn btn-ghost text-xl" href="../index.php">daisyUI</a>
  </div>
  ...
  <div class="navbar-end">
    <a href="../admin/cart.php" class="relative">
    ...
    <div class="dropdown dropdown-end">
      ...
      <ul tabindex="0" class="menu menu-sm dropdown-content bg-gray-400 rounded-box z-[1] mt-3 w-52 p-2 shadow">
        ...
        <?php else: ?>
          <li><a href="../loginsystem/registration.php">Registration</a></li>
