        ...
        <div class="container mx-auto flex items-center justify-between py-4 px-6">
            ...
            <div class="flex items-center space-x-4">
                ...
                <button class="relative p-2 rounded-full bg-gray-100 hover:bg-gray-200">
                    ...
                    <!-- Notification Badge -->
                    <span id="cart-count" href="get_cart_count.php" class="absolute top-0 right-0 transform translate-x-1/2 -translate-y-1/2 bg-red-500 text-white rounded-full px-1.5 py-0.5 text-xs leading-none">0</span>
                </button>
