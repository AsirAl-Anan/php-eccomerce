...
function getAllProducts($conn, $filter = null)
{
...
// Get all products without filter initially
...
?>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <button id="filterAll" class="bg-blue-500 text-white px-2 py-1 rounded mr-2 active">All</button>
        <button id="filterFeatured" class="bg-gray-300 text-gray-700 px-2 py-1 rounded mr-2">Featured</button>
        <button id="filterMen" class="bg-gray-300 text-gray-700 px-2 py-1 rounded mr-2">Men</button>
        <button id="filterWomen" class="bg-gray-300 text-gray-700 px-2 py-1 rounded mr-2">Women</button>
        <button id="filterKids" class="bg-gray-300 text-gray-700 px-2 py-1 rounded">Kids</button>
    </div>
    <div id="productGrid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <?php foreach ($products as $product): ?>
            <div class="border p-4 rounded product-card" data-page="<?php echo htmlspecialchars($product['page']); ?>">
 ...
 document.addEventListener('DOMContentLoaded', function() {
            const filterButtons = document.querySelectorAll('#filterAll, #filterFeatured, #filterMen, #filterWomen, #filterKids');
            ...
            filterButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    filterButtons.forEach(btn => btn.classList.add('bg-gray-300', 'text-gray-700'));
