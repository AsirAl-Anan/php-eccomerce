...
// Add this function to display the filter form
function displayFilterForm($current_page, $sort, $min_price, $max_price, $date_filter) {
    ?>
    <form action="" method="GET" class="mb-8 p-4 bg-gray-100 rounded-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
                <label for="min_price" class="block mb-2">Min Price:</label>
                <input type="number" name="min_price" id="min_price" value="<?php echo $min_price; ?>" min="0" step="0.01" class="w-full p-2 border rounded">
            </div>
            
            <div>
                <label for="max_price" class="block mb-2">Max Price:</label>
                <input type="number" name="max_price" id="max_price" value="<?php echo $max_price < PHP_FLOAT_MAX ? $max_price : ''; ?>" min="0" step="0.01" class="w-full p-2 border rounded">
            </div>
            
            <div>
                <label for="date_filter" class="block mb-2">Date Added:</label>
                <select name="date_filter" id="date_filter" class="w-full p-2 border rounded">
                    <option value="all" <?php echo $date_filter == 'all' ? 'selected' : ''; ?>>All Time</option>
                    <option value="DAY" <?php echo $date_filter == 'DAY' ? 'selected' : ''; ?>>Last 24 Hours</option>
