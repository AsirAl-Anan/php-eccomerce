...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    $button_text = mysqli_real_escape_string($connection, $_POST['button_text']);
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-6">
            ...
            <form action="" method="POST" enctype="multipart/form-data" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="datetime-local" id="start_date" name="start_date" required class="w-full px-3 py-2 border rounded">
                </div>
                <div>
                    <label for="end_date" class="block mb-1">End Date:</label>
                    <input type="datetime-local" id="end_date" name="end_date" required class="w-full px-3 py-2 border rounded">
                </div>
                <div>
