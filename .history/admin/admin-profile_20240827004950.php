...
$admin_id = $_SESSION['admin_loggedin'];
$message = '';
$admin_data = null;
...
// If no admin data found, display an error message
if (!$admin_data) {
        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-96">
            ...
            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="admin_id" value="<?php echo htmlspecialchars($admin_data['admin_id']); ?>" readonly 
