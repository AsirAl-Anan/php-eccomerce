        ...
        <table class="min-w-full bg-white">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <?php endforeach; ?>
                    <th class="py-2 px-4 text-left">Actions</th> <!-- Added "Actions" column -->
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <?php endforeach; ?>
                    <td class="py-2 px-4">
                        <!-- Edit button linking to edit page with the record ID -->
                        <a href="edit_<?= $table ?>.php?id=<?= $row['id'] ?>" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition duration-300">Edit</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
