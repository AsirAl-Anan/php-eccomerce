...
<body class="bg-gray-100">
    ...
    <div class="navbar text-black sticky top-0 z-50 !bg-white !text-black">
        <div class="navbar-start">
            ...
            <div class="dropdown">
                <div tabindex="0" role="button" class="btn btn-ghost lg:hidden">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" title="menu">
                ...
                <ul tabindex="0" class="menu menu-sm dropdown-content bg-white text-black rounded-box z-[1] mt-3 w-52 p-2 shadow">
                    ...
                    <li><a class="hover:underline" href="women.php">Women</a></li>
        ...
        <div class="dropdown dropdown-end">
            ...
            <ul tabindex="0" class="menu menu-sm dropdown-content bg-base-600 rounded-box z-[1] mt-3 w-52 p-2 shadow">
                <?php if (isLoggedIn()): ?>
                    <li><a class="hover:underline" href="pages/profile.php">Profile</a></li>
    ...
    <div class="container mx-auto px-4 py-8 relative z-[60] mt-16">
        ...
        <?php else: ?>
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="mr-2">
                                            <img src="<?php echo htmlspecialchars($item['image_file']); ?>" alt="<?php echo htmlspecialchars($item['name']); ?>" class="w-16 h-16 object-cover rounded-lg">
                                        </div>
                                    </div>
                                </td>
            ...
            <div class="mt-6">
                <h2 class="text-xl font-semibold mb-2">Total: $<?php echo htmlspecialchars(number_format($total, 2)); ?></h2>
