...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $admin_data) {
    ...
    if (!$stmt->execute()) {
        $message .= "<div class='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4' role='alert'>Error updating profile picture: " . $stmt->error . "</div>";
    }
