                    ...
                    <div>
                        ...
                        <div class="flex space-x-2">
                            <button onclick="addToCart(
                                ...
                                <?php echo $product['id']; ?>, '<?php echo htmlspecialchars(addslashes($product['name'])); ?>', <?php echo $product['price']; ?>); console.log('Add to Cart clicked');" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex-grow">
                                Add to Cart
                            </button>
