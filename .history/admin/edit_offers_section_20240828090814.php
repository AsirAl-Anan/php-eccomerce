...
<body class="bg-gray-100 p-8">
    ...
    <form action="" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <input type="text" name="button_text" placeholder="Button Text"  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
