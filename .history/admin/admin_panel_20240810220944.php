...
<body class="bg-gray-100">
    ...
    <form method="POST" action="" enctype="multipart/form-data" class="space-y-4">
        ...
        <div>
            ...
            <input type="number" id="rating" name="rating" step="0.1" min="0" max="5" required class="w-full p-2 border rounded">
        </div>
        <div>
            <label for="page" class="block">Page:</label>
            <select id="page" name="page" required class="w-full p-2 border rounded">
