...
if (isset($_POST['delete_user'])) {
    ...
    try {
        ...
        $tables = ['cart', 'orders', 'product_reviews']; // Add all tables that have a foreign key to users
...
if (isset($_POST['delete_user'])) {
    ...
    try {
        ...
        $sql = "DELETE FROM product_comments WHERE user_id = ?";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("i", $user_id);
        $stmt->execute();

        // Add similar DELETE statements for other tables with foreign key relationships
