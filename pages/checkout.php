...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Store order details in session and redirect to proceed_to_pay.php
    ...
    header('Location: proceed_to_pay.php');
    exit();
}
?>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-2">
                <form method="POST" action="" id="checkout-form" class="bg-white shadow-md rounded-lg p-6">
                    <!-- Shipping Address -->
                    <div class="mb-6">
            ...
            <div>
                <div class="bg-white shadow-md rounded-lg p-6 sticky top-8">
                    ...
                    <button type="submit" form="checkout-form" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition duration-200">
                        Proceed to Checkout
                    </button>
                </div>
            </div>
